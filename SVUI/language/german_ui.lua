...
L["Supervillain UI Installation"]="Supervillain UI Installation"
L["Finished"]="Beendet"
...
L["Welcome to Supervillain UI version %s!"]="Willkommen bei SVUI Version %s!"
...
L["You can always change fonts and colors of any element of Supervillain UI from the in-game configuration."]='Du kannst jederzeit in der Ingame-Konfiguration Schriften und Farben von jedem Element des Interfaces ändern.'
