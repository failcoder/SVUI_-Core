...
L["Gloom & Doom"]="Темная"
L["Disable"]="Выключить"
L["Supervillain UI Installation"]="Установка SVUI"
...
L["Welcome to Supervillain UI version %s!"]="Добро пожаловать в SVUI версии %s!"
...
L["You can always change fonts and colors of any element of Supervillain UI from the in-game configuration."]="Вы всегда можете изменить шрифты и цвета любого элемента SVUI из меню конфигурации. Классическая и пиксельная темы не отличаются для русского клиента."
...
L["If you are experiencing issues with SVUI try disabling all your addons except SVUI, remember SVUI is a full UI replacement addon, you cannot run two addons that do the same thing."]='Если Вы испытываете проблемы с SVUI, попробуйте отключить все аддоны, кроме самого SVUI. Помните, SVUI это аддон, полностью заменяющий интерфейс, Вы не можете одновременно использовать два аддона, выполняющих одинаковые функции.'
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of SVUI."]='Панель с баффами справа от миникарты это список Ваших объединенных баффов. Вы можете отключить ее в разделе эффектов и аур в настройках SVUI.'
