...
L["Gloom & Doom"]="黑暗"
L["Disable"]="禁用"
L["Supervillain UI Installation"]="安装 SVUI"
L["Finished"]="完成"
L["Grid Size:"]="网格尺寸:"
L["Healer"]="治疗"
...
L["Welcome to Supervillain UI version %s!"]="欢迎使用 SVUI 版本 %s!"
...
L["You can always change fonts and colors of any element of Supervillain UI from the in-game configuration."]="你可以在游戏内的设定选项内更改SVUI的字体、颜色等设定."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in SVUI. Press accept if you would like to disable the Auto Scale option."]="你改变了界面缩放比例，然而SVUI的自动缩放选项是开启的。点击接受以关闭SVUI的自动缩放。"
...
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of SVUI."]="小地图右侧的光环条是你的整合Buff条, 你可以在你的SVUI光环设置中关闭此功能."
