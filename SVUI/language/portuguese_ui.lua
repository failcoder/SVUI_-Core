...
L["Gloom & Doom"]="Escuro"
L["Disable"]="Desativar"
L["Supervillain UI Installation"]="Instalação do SVUI"
...
L["Welcome to Supervillain UI version %s!"]="Bem-vindo à versão %s da SVUI!"
...
L["You can always change fonts and colors of any element of Supervillain UI from the in-game configuration."]="As cores e fontes da SVUI podem ser mudadas em qualquer momento no modo de configuração demtro do jogo."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in SVUI. Press accept if you would like to disable the Auto Scale option."]="Você mudou a Escala da sua IU, no entanto ainda tem a opção de dimensionamento automático ativa na SVUI. Pressione Aceitar se gostaria de desativar a opção de dimensionamento automático."
...
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of SVUI."]="O painel de bônus a direita do minimapa é uma lista dos seus bônus consolidados. Você pode desativar isto nas opções de Bônus e Penalidades da SVUI."
