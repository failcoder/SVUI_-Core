...
L["Gloom & Doom"]=true;
L["Disable"]=true;
L["Supervillain UI Installation"]=true;
L["Finished"]=true;
L["Grid Size:"]=true;
L["Healer"]=true;
...
L["Welcome to Supervillain UI version %s!"]=true;
...
L["You have changed your UIScale, however you still have the AutoScale option enable in SVUI. Press accept if you would like to disable the Auto Scale option."]=true;
