...
L["Gloom & Doom"]="黑暗"
L["Disable"]="禁用"
L["Supervillain UI Installation"]="安裝 SVUI"
L["Finished"]="設定完畢"
L["Grid Size:"]="網格尺寸："
L["Healer"]="補師"
...
L["Welcome to Supervillain UI version %s!"]="歡迎使用 SVUI %s 版！"
...
L["You can always change fonts and colors of any element of Supervillain UI from the in-game configuration."]="你可以在遊戲內的設定選項內更改SVUI的字體、顏色等設定."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in SVUI. Press accept if you would like to disable the Auto Scale option."]="你改變了介面縮放比例, 然而SVUI的自動縮放選項是開啟的. 點擊接受以關閉SVUI的自動縮放."
...
L["The buff panel to the right of minimap is a list of your consolidated buffs. You can disable it in Buffs and Debuffs options of SVUI."]="小地圖右側的光環條是你的整合Buff條, 你可以在你的SVUI光環設定中關閉此功能."
