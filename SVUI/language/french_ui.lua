...
L["Supervillain UI Installation"]="Installation d'SVUI"
L["Finished"]="Terminé"
...
L["Welcome to Supervillain UI version %s!"]="Bienvenue sur la version %s d'SVUI!"
...
L["You can always change fonts and colors of any element of Supervillain UI from the in-game configuration."]="Vous pouvez toujours modifier les polices et les couleurs de n'importe quel élément d'SVUI dans la configuration du jeu."
...
L["You have changed your UIScale, however you still have the AutoScale option enable in SVUI. Press accept if you would like to disable the Auto Scale option."]="Vous venez de changer l'échelle de votre interface, alors que votre option d'échelle automatique est encore activée dans SVUI. Cliquer sur accepter si vous voulez désactiver l'option d'échelle automatique."
